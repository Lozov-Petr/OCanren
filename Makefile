...
SRC=src,src/core,src/std,src/unfolding
...
######################## Tests related stuff  ##########################
REGRES_CASES := 000 002sort 001 004 005 006 007 009 010 011 013 014 015runaway 016sorto 017tabling 018prjc 019tablingCache 020 021structural 022reverso 023bridge 024sort 025repeat 026sort_unf 027repeat_unf
